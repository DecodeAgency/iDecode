...
public partial class app_journo_profileedit : System.Web.UI.Page
{
    ...
    protected async void Page_Load(object sender, EventArgs e)
    {
        ...
        doc = new XmlDocument();
        s = Convert.ToString(oDecode.LoadUserJobs(Convert.ToInt16(Session["iUserID"].ToString())).InnerXml);
        doc.LoadXml(s);
    ...
    {
        var oDecode = new za.co.idecode.test.idecode();
        bool bAddJob = oDecode.NewUserJob(Convert.ToInt32(Session["iUserID"].ToString()),txtPublication.Text,Convert.ToDateTime(txtStartDate.Text),Convert.ToDateTime(txtEndDate.Text),txtWebAddress.Text,txtPosition.Text,txtDepartment.Text,false);
