...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <div class="LeftBlockContainer">
        <div class="Block">
            <h3>Search for Communicators</h3>
            <center>
                <asp:TextBox runat="server" ID="txtkeyword" CssClass="SearchTextBoxes" Text="e.g. Spokesperson" onfocus='if (this.value == "e.g. Spokesperson"){this.value = "";}' onblur='if (this.value == ""){this.value = "e.g. Spokesperson"}' />
                <asp:TextBox runat="server" ID="txtCommunicatorName" ClientIDMode="Static" CssClass="SearchTextBoxes" Text="e.g. Margaret Dingalo" onfocus='if (this.value == "e.g. Margaret Dingalo"){this.value = "";}' onblur='if (this.value == ""){this.value = "e.g. Margaret Dingalo"}'/>
                <asp:TextBox runat="server" ID="txtDepartment" CssClass="SearchTextBoxes" Text="e.g. Gauteng Provincial Government" onfocus='if (this.value == "e.g. Gauteng Provincial Government"){this.value = "";}' onblur='if (this.value == ""){this.value = "e.g. Gauteng Provincial Government"}' />
                <asp:TextBox runat="server" ID="txtLocation" CssClass="SearchTextBoxes" Text="e.g. Eastern Cape" onfocus='if (this.value == "e.g. Eastern Cape"){this.value = "";}' onblur='if (this.value == ""){this.value = "e.g. Eastern Cape"}' />
